...
class DeviceSearch: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mContext = this
        val bleOnOffBtn:Switch = findViewById(R.id.bluetooth_switch)
        ...
        recyclerViewAdapter.mListener = object : RecyclerViewAdapter.OnItemClickListener{
            override fun onClick(view: View, position: Int) {
                ...
                bleGatt =  DeviceControl(mContext, bleGatt).connectGatt(device)
            }
        }
    ...
    class RecyclerViewAdapter(private val myDataset: ArrayList<BluetoothDevice>) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup,
            ...
            val linearView = LayoutInflater.from(parent.context)
                .inflate(R.layout.activity_device_recyclerview, parent, false) as LinearLayout
